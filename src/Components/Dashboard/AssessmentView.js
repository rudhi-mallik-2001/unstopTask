...
const AssessmentView = () => {
    return (
        <div className='w-[95%] flex flex-col lg:flex-row flex-wrap border-2 rounded-[20px] justify-around items-center divide-y xl:divide-y-0 xl:divide-x-2 m-auto'>
            <div className='w-full xl:w-[50%] flex flex-row divide-x'>
                <div className='w-[25%] min-h-[70px] flex flex-col gap-y-2 justify-start items-start p-2'>
                    <p className='text-[14px] text-[#6548EE]'>Total Purpose</p>
                    <div className='w-full flex flex-row gap-x-2 justify-start mt-2'>
                        ...
                        <p className='text-[20px] font-bold text-[#1C4980]'>34</p>
                    </div>
                </div>
                <div className='w-[65%] min-h-[70px] flex flex-col justify-center items-start p-2'>
                    ...
                    <div className='w-full flex flex-row gap-y-2 p-1 divide-x'>
                        <div className='w-[50%] flex flex-row justify-start items-center gap-x-2 '>
                            ...
                            <div className='flex flex-col'>
                                <p className='text-[20px] font-bold text-[#1C4980]'>11,145
                        ...
                        <div className='w-[48%] flex flex-col gap-y-2 p-2'>
                            <div className='w-full flex flex-col gap-x-2'>
                                <p className='text-[20px] font-bold text-[#1C4980]'>1,14 <span className='text-[12px] text-green-600'>+84</span></p>
            ...
            <div className='w-full xl:w-[50%] flex flex-row divide-x min-h-[120px]'>
                <div className='w-[65%] min-h-[70px] flex flex-col justify-center items-start p-2'>
                    <p className='text-[14px] text-[#6548EE]'>Candidates Source</p>
                    <div className='w-full flex flex-row gap-y-2 p-1 justify-start items-start mt-2'>
                        <div className='w-full flex flex-row justify-start items-center gap-x-2 '>
                            <span className='flex border-2 rounded-[10px] px-[5px] py-[5px]'>
                                <LanguageIcon className='text-[#D63500]' />
                            </span>
                            <div className='flex flex-col'>
                                <p className='text-[20px] font-bold text-[#1C4980]'>11,145
                                    <span className='text-[14px] text-green-600'>+84</span>
                                </p>
                ...
                <div className='w-[25%] min-h-[70px] flex flex-col justify-start items-start gap-y-2 p-2'>
